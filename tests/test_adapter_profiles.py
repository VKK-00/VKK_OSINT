...
class AdapterProfileTests(unittest.TestCase):
    def test_list_and_find_adapter_profile(self):
        ...
        self.assertIn("blacklanternsecurity/bbot-passive-email", profiles["domain-recon"].repositories)
        ...
        self.assertIn("bbot-passive-email", profiles)
        self.assertIn("blacklanternsecurity/bbot-passive-email", profiles["bbot-passive-email"].repositories)
