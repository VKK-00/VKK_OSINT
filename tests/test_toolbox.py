...
class ToolboxTests(unittest.TestCase):
    ...
    def test_rendered_html_contains_profiles_and_photo_boundary(self):
        ...
        self.assertIn("/api/cases/export", html)
        self.assertIn("/api/cases/${encodeURIComponent(caseId)}/sources", html)
        self.assertIn("/api/cases/${encodeURIComponent(caseId)}/export", html)
        ...
        self.assertIn("case-export", html)
        self.assertIn("cases-export", html)
        ...
        self.assertIn("exportCasePackage", html)
        self.assertIn("exportFilteredCases", html)
