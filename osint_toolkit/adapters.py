...
ADAPTERS: tuple[AdapterSpec, ...] = (
    ...
    AdapterSpec(
        ...
        "planned",
        "",
        "CLI/API output format and current license need a separate adapter pass before enabling execution.",
        ("domain",),
        install_kind="manual",
        install_note="Install from upstream README/wiki; command template is intentionally not enabled until output format and license are reviewed.",
...
ADAPTER_PROFILES: tuple[AdapterProfile, ...] = (
    ...
    AdapterProfile(
        ...
        note="Default profile stays passive; active/bruteforce Amass modes and theHarvester execution are separate scope decisions.",
    ),
)
