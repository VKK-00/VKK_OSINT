...
- запускать Subfinder, httpx, пассивный Amass и theHarvester domain-recon adapters и нормализовать subdomains/emails/URLs/HTTP probe results в общий graph;
...
python -m osint_toolkit investigate --domain example.com --include-adapters --adapter-profile domain-recon --adapter-limit 4
