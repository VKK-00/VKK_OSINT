...
- выполнять baseline email checks: синтаксис, local-part profile hints, live domain resolution, MX/NS/TXT lookup, hosted provider attribution, SPF, DMARC, MTA-STS, TLS-RPT, BIMI и публичные TXT service signals;
