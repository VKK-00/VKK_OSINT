...
- запускать Subfinder, httpx и пассивный Amass domain-recon adapters и нормализовать subdomains/HTTP probe results в общий graph;
...
python -m osint_toolkit investigate --domain example.com --include-adapters --adapter-profile domain-recon --adapter-limit 3
